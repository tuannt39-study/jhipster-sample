  ...
  return (
    <div>
      <h2 id="location-heading">
        <Translate contentKey="jdemoApp.location.home.title">Locations</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jdemoApp.location.home.createLabel">Create new Location</Translate>
        </Link>
      </h2>
        ...
        {locationList && locationList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jdemoApp.location.home.notFound">No Locations found</Translate>
            </div>
          )
        )}
      </div>
