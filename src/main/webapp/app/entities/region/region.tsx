  ...
  return (
    <div>
      <h2 id="region-heading">
        <Translate contentKey="jdemoApp.region.home.title">Regions</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jdemoApp.region.home.createLabel">Create new Region</Translate>
        </Link>
      </h2>
        ...
        {regionList && regionList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jdemoApp.region.home.notFound">No Regions found</Translate>
            </div>
          )
        )}
      </div>
