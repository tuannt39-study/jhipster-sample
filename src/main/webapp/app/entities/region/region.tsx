  ...
  return (
    <div>
      <h2 id="region-heading" data-cy="RegionHeading">
        <Translate contentKey="goApp.region.home.title">Regions</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="goApp.region.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="goApp.region.home.createLabel">Create new Region</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('goApp.region.home.search')}
                />
        ...
        {regionList && regionList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="goApp.region.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="goApp.region.regionName">Region Name</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="goApp.region.home.notFound">No Regions found</Translate>
            </div>
          )
        )}
      </div>
