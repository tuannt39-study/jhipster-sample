...
@RestController
@RequestMapping("/api/go-kafka")
public class GoKafkaResource {

    private final Logger log = LoggerFactory.getLogger(GoKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public GoKafkaResource(KafkaProperties kafkaProperties) {
