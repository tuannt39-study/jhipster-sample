...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '52009385-69b2-4ef8-8192-2b6a501d0083' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('d09db7fd-2d87-4369-913c-60d3fb219d55');
      cy.get(`[data-cy="name"]`).should('have.value', 'd09db7fd-2d87-4369-913c-60d3fb219d55');
